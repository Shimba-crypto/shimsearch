  ...
  return (
    <div className="max-w-sm mx-auto mt-16">
      ...
      <form onSubmit={submit} className="space-y-3">
        ...
        <button disabled={loading} className="w-full bg-[#1a73e8] text-white text-sm font-medium py-2.5 rounded-full hover:bg-[#1765cc] disabled:opacity-50">{loading ? "..." : "Log in"}</button>
      </form>
      ...
      <a href="/api/auth/sso" className="w-full border border-gray-300 text-[#202124] text-sm font-medium py-2.5 rounded-full hover:bg-gray-50 flex items-center justify-center gap-2">
        Login with Auther
      </a>
